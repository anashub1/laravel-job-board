  ...
  <form method="POST" action="/blog/{{$post->id}}">
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base/7 font-semibold text-gray-900">Eedit Post :{{$post->title}}</h2>
        <p class="mt-1 text-sm/6 text-gray-600">use this form to edit post </p>
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Title</label>
            <div class="mt-2">
              <input id="first-name" value="{{old('title', $post->title)}}" type="text" name="title"
      ...
      @enderror
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <input id="last-name" value="{{old('author', $post->author)}}" type="text" name="author"
              ...
              <div class="flex gap-3">
                <div class="flex h-6 shrink-0 items-center">
                  <div class="group grid size-4 grid-cols-1">
                    <input id="published" type="checkbox" value="1" {{ old('published') || (!old() && $post->published) ? 'checked' : '' }} name="published" checked aria-describedby="comments-description"
